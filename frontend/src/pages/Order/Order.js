    ...
    <div className="placeorder">
      ...
      <div className="informations-placeorder">
        <div className="shipping-placeorder">
          ...
          {order.isDelivered ? (
            <h4 className="paid">Delivered at {order.deliveredAt}</h4>
          ) : (
            <h4 className="notpaid">NOT Delivered YET</h4>
          )}
        </div>
        <hr className="hr" />
        <div className="payment-placeorder">
          ...
          {order.paymentMethod}
          {order.isPaid ? (
            <p className="paid">PAID AT {order.paidAt}</p>
          ) : (
            <p className="notpaid">NOT PAID YET</p>
          )}
        </div>
        <hr className="hr" />
        <div>
